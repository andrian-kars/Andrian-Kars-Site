            ...
            <div className={s.home}>
                ...
                <div className={s.whrapper_mobile}>
                    ...
                    <div className={s.content}>
                        <ul className={s.info}>
                            <li className={s.item}><p className={s.text}><span className={s.bold}>Age:</span>20 Years</p></li>
                            <li className={s.item}><a className={s.text} href="https://www.codewars.com/users/andrian-kars"><span className={s.bold}>CodeWars:</span>3rd kyu</a></li>
                        ...
                        <div className={s.buttons}>
                            ...
                            <a className={s.button} href="https://www.linkedin.com/in/andrian-kars/" rel="noopener noreferrer" target="_blank">Hire me</a>
                        </div>
                    </div>
                </div>
            </div>
