                    ...
                    <div className={s.content_whrapper}>
                        <div className={s.touch}>
                            ...
                            <div className={s.info}>
                                ...
                                <div className={s.item}>
                                    <a className={`${s.image} ${s.smaller}`} href="https://telegram.me/pmAndrian" target="_blank">
                                    ...
                                    <div className={s.description}>
                                        ...
                                        <a className={s.bottom_text} href="https://telegram.me/pmAndrian" target="_blank">pmAndrian</a>
                                    </div>
                                </div>
                                <div className={s.item}>
                                    <a className={`${s.image} ${s.smaller}`} href="https://www.linkedin.com/in/andrian-kars/" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" /></svg>
                                    </a>
                                    <div className={s.description}>
                                        <p className={s.top_text}>LinkedIn Profile</p>
                                        <a className={s.bottom_text} href="https://www.linkedin.com/in/andrian-kars/" target="_blank">andrian-kars</a>
                                    </div>
                                </div>
                                <div className={s.item}>
                                    <a className={`${s.image} ${s.smaller}`} href="https://join.skype.com/invite/lOUIqjuQHr0s" target="_blank">
                                    ...
                                    <div className={s.description}>
                                        ...
                                        <a className={s.bottom_text} href="https://join.skype.com/invite/lOUIqjuQHr0s" target="_blank">andrian19-19</a>
                                    </div>
                                </div>
                            </div>
                        </div>
