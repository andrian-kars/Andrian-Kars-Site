        ...
        <section className={s.main}>
            ...
            <nav className={s.navigation}>
                <ul className={s.navigation_whrapper}>
                    <li className={s.item}>
                        <NavLink className={s.link} activeClassName={s.active} exact to="/">Home</NavLink>
                    </li>
                    <li className={s.item}>
                        <NavLink className={s.link} activeClassName={s.active} exact to="/about">About me</NavLink>
                    </li>
                    <li className={s.item}>
