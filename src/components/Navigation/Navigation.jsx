        ...
        <section className={s.main}>
            ...
            <nav className={s.navigation}>
                <ul className={s.navigation_whrapper}>
                    ...
                    <li className={s.item}>
                        <NavLink className={s.link} activeClassName={s.active} exact to="/about">About me
                            <svg viewBox="0 0 20 20">
                    ...
                    <li className={s.item}>
                        <NavLink className={s.link} activeClassName={s.active} exact to="/resume">My resume
                            <svg viewBox="0 0 20 20">
                    ...
                    <li className={s.item}>
                        <NavLink className={s.link} activeClassName={s.active} exact to="/portfolio">Portfolio
                            <svg viewBox="0 0 20 20">
                    ...
                    <li className={s.item}>
                        <NavLink className={s.link} activeClassName={s.active} exact to="/contact">Contact
                            <svg viewBox="0 0 20 20">
